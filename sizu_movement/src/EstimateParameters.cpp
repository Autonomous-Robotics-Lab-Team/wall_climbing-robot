...
#include <sensor_msgs/Imu.h>
    ...
    int EstimateParameters::Climb() {
        if(!climbing_){
            return 0;
        }
        leg_sign = {0,1,2,3};

        FL_position_body << 0.1, -0.2 ,0.5;
        All_Feet_position.block(0,0,3,1)=FL_position_body;
        move.commandSend(All_Feet_position, leg_sign);
        ros::Duration(2).sleep();
       
        FL_position_body << 0.15, -0.2 ,0.3;
        All_Feet_position.block(0,0,3,1)=FL_position_body;
        move.commandSend(All_Feet_position, leg_sign);
        ros::Duration(2).sleep();

        FR_position_body << 0.1, 0.2 ,0.5;
        All_Feet_position.block(0,2,3,1)=FR_position_body;
        move.commandSend(All_Feet_position, leg_sign);
        ros::Duration(2).sleep();
       
        FR_position_body << 0.15, 0.2 ,0.3;
        All_Feet_position.block(0,2,3,1)=FR_position_body;
        move.commandSend(All_Feet_position, leg_sign);
        ros::Duration(2).sleep();

        FL_position_body << 0.15, -0.2 ,0.1;
        FR_position_body << 0.15, 0.2 ,0.1;
        RL_position_body << -0.1, 0 ,0;
        RR_position_body << -0.1, 0 ,0;
        All_Feet_position.block(0,0,3,1)=FL_position_body;
        All_Feet_position.block(0,2,3,1)=FR_position_body;
        All_Feet_position.block(0,1,3,1)=RL_position_body;
        All_Feet_position.block(0,3,3,1)=RR_position_body;
        ...
        FL_position_body << 0.1, -0.2 ,0.35;
        All_Feet_position.block(0,0,3,1)=FL_position_body;
        move.commandSend(All_Feet_position, leg_sign);
        ros::Duration(2).sleep();

        FL_position_body << 0.2, -0.2 ,0.25;
        All_Feet_position.block(0,0,3,1)=FL_position_body;
        move.commandSend(All_Feet_position, leg_sign);
        ros::Duration(2).sleep();

        FR_position_body << 0.1, 0.2 ,0.35;
        All_Feet_position.block(0,2,3,1)=FR_position_body;
        move.commandSend(All_Feet_position, leg_sign);
        ros::Duration(2).sleep();

        FR_position_body << 0.2, 0.2 ,0.25;
        All_Feet_position.block(0,2,3,1)=FR_position_body;
        move.commandSend(All_Feet_position, leg_sign);
        ros::Duration(2).sleep();

        FL_position_body << 0.1, -0.2 ,0.0;
        FR_position_body << 0.1, 0.2 ,0.0;
        RL_position_body << -0.2, 0 ,0.08;
        RR_position_body << -0.2, 0 ,0.08;
        All_Feet_position.block(0,0,3,1)=FL_position_body;
        All_Feet_position.block(0,2,3,1)=FR_position_body;
        All_Feet_position.block(0,1,3,1)=RL_position_body;
        All_Feet_position.block(0,3,3,1)=RR_position_body;
        ...
        RL_position_body << -0.1, 0 ,0.2;
        All_Feet_position.block(0,1,3,1)=RL_position_body;;
        move.commandSend(All_Feet_position, leg_sign);
        ros::Duration(1).sleep();

        RL_position_body << 0, 0 ,0.0;
        All_Feet_position.block(0,1,3,1)=RL_position_body;;
        move.commandSend(All_Feet_position, leg_sign);
        ros::Duration(1).sleep();

        RR_position_body << -0.1, 0 ,0.2;
        All_Feet_position.block(0,3,3,1)=RR_position_body;;
        move.commandSend(All_Feet_position, leg_sign);
        ros::Duration(1).sleep();

        RR_position_body << 0, 0 ,0.0;
        All_Feet_position.block(0,3,3,1)=RR_position_body;;
        move.commandSend(All_Feet_position, leg_sign);
        ros::Duration(1).sleep();
